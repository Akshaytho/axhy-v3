...
| **Status**                              | `CHANGES_REQUESTED` (round 3, 2026-05-16) — friend's review found 2 smaller bugs introduced by round-2 (P1 validation regression on /chat/apply + P2 overclaimed route-level stale-auth proof). Plus owner asks to adopt a same-day supervisor-freeze policy that would simplify the underlying complexity. Plan in `pending-approvals.md`; no code until approved.                 |
