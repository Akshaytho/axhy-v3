...
// NOTE: this script imports @playwright/test which only resolves from
// apps/mobile/node_modules. To run, copy/symlink to apps/mobile/scripts/
// and run from cwd=apps/mobile with `pnpm exec tsx scripts/qa-round3-supervisor.ts`.
// A copy lives at apps/mobile/scripts/qa-round3-supervisor.ts for that purpose.
const OUT_ROOT = path.resolve(__dirname, '..', '..', 'apps/mobile/screenshots-sprint-2/qa-round3');
