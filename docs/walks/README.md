...
| ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------- | -------- | -------------------- |
| **worker-screens** (umbrella: onboarding+home+capture+visit+history+profile+leave) | [2026-06-10-2345](worker-screens/2026-06-10-2345/) (2026-06-10 23:45 IST) | IN_PROGRESS (live vs prod: steps 1-6,19-20 + 4 bad-day scenarios DONE; capture 7-17 awaits founder visit-seed OK) | 3 (orphan history; leave→profile broken promise; help→admin-login wall) — PRELIM RCA: all 3 = ONE root (unwired secondary surfaces) | —           | —       | no       | BROKEN (bugs open)   |
