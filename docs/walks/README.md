...
| **supervisor-screens** (today+decisions+activity+chat+me + hidden summary/updates/memory/sites/replacement-picker) | [2026-06-11-1030](supervisor-screens/2026-06-11-1030/) (2026-06-11 10:30 IST) | BUGS_OPEN — live phase DONE (19:23–20:20 IST, full 4-layer proofs); C-D root FIXED `b225a50` | 10 → 4 roots (3 BLOCKER: reversal dead-end, stale decisions, apply refusal) | 1 of 4 (C-D: precheck+names+refresh+plain errors; mobile live-proven, backend deploy-pending) | partial (C-D, evidence/13-15) | no       | BROKEN until C-C (reversal window) + C-E (word-truth copy) land; the AI→decision→apply core is now proven |
