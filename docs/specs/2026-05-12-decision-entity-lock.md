...
| r3 design (2026-05-11; superseded by R6 2026-05-12)                                                           | Decisions Workspace is a top-level tab; "Review N decisions →" link pushes from chat. Canonical surface design now in R6 (Active).                                                                                       | Schema does not yet support standalone decisions independent of chat messages.                                          |
...
- r6 supervisor design (canonical surface): `docs/specs/2026-05-12-supervisor-mobile-r6-design.md` (Active 2026-05-12); provides the UI surfaces this spec backs
- r3 supervisor design (historical predecessor): `docs/specs/2026-05-11-supervisor-mobile-r3-design.md` (Superseded by R6 on 2026-05-12; preserved for traceability)
