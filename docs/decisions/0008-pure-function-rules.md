# ADR-0008: Pure-function business rules
...
This ADR was referenced in code via `@derives(ADR-0008)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0008)'
