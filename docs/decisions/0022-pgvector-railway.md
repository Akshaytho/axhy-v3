# ADR-0022: pgvector on existing Railway Postgres
...
This ADR was referenced in code via `@derives(ADR-0022)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0022)'
