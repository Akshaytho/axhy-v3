# ADR-0004: Backend: Fastify + Prisma + Postgres on Railway
...
This ADR was referenced in code via `@derives(ADR-0004)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0004)'
