# ADR-0006: XState v5 for state machines
...
This ADR was referenced in code via `@derives(ADR-0006)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0006)'
