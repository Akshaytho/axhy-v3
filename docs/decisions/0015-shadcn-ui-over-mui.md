# ADR-0015: shadcn/ui over Material UI
...
This ADR was referenced in code via `@derives(ADR-0015)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0015)'
