# ADR-0016: RN Reusables for mobile UI
...
This ADR was referenced in code via `@derives(ADR-0016)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0016)'
