# ADR-0007: Phone+OTP auth via MSG91 + jose JWT
...
This ADR was referenced in code via `@derives(ADR-0007)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0007)'
