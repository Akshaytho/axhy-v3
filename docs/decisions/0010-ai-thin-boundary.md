# ADR-0010: AI at user-input boundary only (thin-AI)
...
This ADR was referenced in code via `@derives(ADR-0010)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0010)'
