# ADR-0012: Hybrid STT — Sarvam + Whisper
...
This ADR was referenced in code via `@derives(ADR-0012)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0012)'
