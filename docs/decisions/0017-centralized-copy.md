# ADR-0017: Centralized copy catalog
...
This ADR was referenced in code via `@derives(ADR-0017)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0017)'
