# ADR-0018: Centralized error catalog
...
This ADR was referenced in code via `@derives(ADR-0018)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0018)'
