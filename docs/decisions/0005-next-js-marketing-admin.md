# ADR-0005: Marketing + admin in one Next.js app
...
This ADR was referenced in code via `@derives(ADR-0005)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0005)'
