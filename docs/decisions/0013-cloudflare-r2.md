# ADR-0013: Cloudflare R2 for file storage
...
This ADR was referenced in code via `@derives(ADR-0013)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0013)'
