# ADR-0003: Single source of truth for schema
...
This ADR was referenced in code via `@derives(ADR-0003)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0003)'
