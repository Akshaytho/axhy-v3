# ADR-0011: Auto-generated typed API clients
...
This ADR was referenced in code via `@derives(ADR-0011)` before its full body
...
- **Affects:** see code references via grep '@derives(ADR-0011)'
